...
{
	[Serializable]
	public class Z7A : AbstractSegment
	{
		public CE YiZhuLb
		{
			get
		...
		public Z7A(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
