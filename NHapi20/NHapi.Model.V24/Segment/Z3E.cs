...
{
	[Serializable]
	public class Z3E : AbstractSegment
	{
		public ST GeiYaoFsId
		{
			get
			{
				ST sT = null;
		...
		public Z3E(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			...
			try
			{
				...
				add(typeof(ST), required: false, 1, 3, new object[1]
				{
					message
				}, "适用厨房类型");
				add(typeof(NM), required: false, 1, 1, new object[1]
				...
				add(typeof(SI), required: true, 1, 6, new object[1]
				{
					message
				}, "顺序号");
				add(typeof(NM), required: false, 1, 1, new object[1]
				...
				add(typeof(CE), required: false, 1, 20, new object[1]
				{
					message
				}, "适用范围");
