...
{
	[Serializable]
	public class Z6G : AbstractSegment
	{
		public ST JianChaBwId
		{
			get
			{
				ST sT = null;
		...
		public Z6G(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
