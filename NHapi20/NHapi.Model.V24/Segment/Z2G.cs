...
{
	public class Z2G : AbstractSegment
	{
		public ST ChuangWei
		{
			get
		...
		public Z2G(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			...
			try
			{
				...
				add(typeof(XCN), required: true, 1, 50, new object[1]
				{
					message
				}, "修改人");
