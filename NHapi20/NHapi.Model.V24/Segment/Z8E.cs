...
{
	[Serializable]
	public class Z8E : AbstractSegment
	{
		public ST LuJingID
		{
			get
		...
		public int ShiYingLJJBXXRepetitionsUsed
		{
			get
			{
				try
		...
		public int ShouShuXXRepetitionsUsed
		{
			get
			{
				try
		...
		public int BianYiYYRepetitionsUsed
		{
			get
			{
				try
		...
		public int YingYongKSRepetitionsUsed
		{
			get
			{
				try
		...
		public Z8E(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			...
			try
			{
				...
				add(typeof(CE), required: true, 0, 200, new object[1]
				{
					message
				}, "适应路径疾病信息");
				add(typeof(CE), required: true, 0, 200, new object[1]
		...
		public CE GetShiYingLJJBXX(int rep)
		{
			CE cE = null;
			try
			{
		...
		public CE GetShouShuXX(int rep)
		{
			CE cE = null;
			try
			{
				IType field = GetField(4, rep);
				return (CE)field;
			}
			catch (Exception ex)
			{
		...
		public CE[] GetShouShuXX()
		{
			CE[] array = null;
			try
			{
				IType[] field = GetField(4);
				array = new CE[field.Length];
				for (int i = 0; i < array.Length; i++)
				{
					array[i] = (CE)field[i];
		...
		public CE GetYingYongKS(int rep)
		{
			CE cE = null;
			try
			{
