...
{
	[Serializable]
	public class Z3N : AbstractSegment
	{
		public ST PiShiClYjID
		{
			get
			{
				ST sT = null;
		...
		public Z3N(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			...
			try
			{
				...
				add(typeof(SI), required: false, 0, 6, new object[1]
				{
					message
				}, "顺序号");
				add(typeof(NM), required: false, 1, 1, new object[1]
