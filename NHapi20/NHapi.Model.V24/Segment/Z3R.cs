...
{
	public class Z3R : AbstractSegment
	{
		public ST YaoPinKcID
		{
			get
			{
				ST sT = null;
		...
		public Z3R(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
