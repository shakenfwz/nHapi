...
{
	[Serializable]
	public class Z6I : AbstractSegment
	{
		public ST JianChaXmId
		{
			get
			{
				ST sT = null;
		...
		public Z6I(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			...
			try
			{
				...
				add(typeof(ST), required: false, 1, 250, new object[1]
				{
					message
				}, "");
				add(typeof(ST), required: false, 1, 250, new object[1]
