...
{
	[Serializable]
	public class Z6A : AbstractSegment
	{
		public ST JianYanXmId
		{
			get
			{
				ST sT = null;
		...
		public Z6A(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
