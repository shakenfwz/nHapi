...
{
	[Serializable]
	public class MFN_Z3E_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3E_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3E_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3E), required: true, repeating: false);
			}
