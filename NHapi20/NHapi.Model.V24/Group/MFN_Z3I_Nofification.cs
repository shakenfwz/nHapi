...
{
	public class MFN_Z3I_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3I_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3I_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3I), required: true, repeating: false);
			}
