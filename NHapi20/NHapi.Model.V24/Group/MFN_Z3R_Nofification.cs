...
{
	public class MFN_Z3R_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3R_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3R_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3R), required: true, repeating: false);
			}
