...
{
	[Serializable]
	public class MFN_Z3D_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3D_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3D_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3D), required: true, repeating: false);
			}
