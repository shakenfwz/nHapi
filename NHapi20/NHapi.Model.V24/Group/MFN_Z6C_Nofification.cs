...
{
	[Serializable]
	public class MFN_Z6C_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z6C_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z6C), required: true, repeating: false);
			}
