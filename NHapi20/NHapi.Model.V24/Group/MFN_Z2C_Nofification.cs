...
{
	[Serializable]
	public class MFN_Z2C_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z2C_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z2C_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z2C), required: true, repeating: false);
			}
