...
{
	[Serializable]
	public class MFN_Z7F_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z7F_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z7F_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z7F), required: true, repeating: false);
			}
