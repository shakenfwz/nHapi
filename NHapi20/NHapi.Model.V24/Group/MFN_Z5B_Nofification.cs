...
{
	[Serializable]
	public class MFN_Z5B_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z5B_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z5B_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z5B), required: true, repeating: false);
			}
