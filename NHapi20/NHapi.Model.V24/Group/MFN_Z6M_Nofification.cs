...
{
	[Serializable]
	public class MFN_Z6M_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z6M_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z6M_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z6M), required: true, repeating: false);
			}
