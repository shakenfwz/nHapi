...
{
	[Serializable]
	public class MFN_Z5H_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z5H_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z5H_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z5H), required: true, repeating: false);
			}
