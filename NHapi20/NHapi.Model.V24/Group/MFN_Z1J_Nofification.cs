...
{
	[Serializable]
	public class MFN_Z1J_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z1J_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z1J_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z1J), required: true, repeating: false);
			}
