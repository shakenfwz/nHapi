...
{
	[Serializable]
	public class MFN_Z2K_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z2K_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z2K_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z2K), required: true, repeating: false);
			}
