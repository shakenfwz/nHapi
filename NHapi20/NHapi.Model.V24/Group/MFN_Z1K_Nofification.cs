...
{
	[Serializable]
	public class MFN_Z1K_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z1K_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z1K_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z1K), required: true, repeating: false);
			}
