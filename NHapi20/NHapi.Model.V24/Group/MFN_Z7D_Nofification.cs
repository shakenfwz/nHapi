...
{
	[Serializable]
	public class MFN_Z7D_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z7D_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z7D_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z7D), required: true, repeating: false);
			}
