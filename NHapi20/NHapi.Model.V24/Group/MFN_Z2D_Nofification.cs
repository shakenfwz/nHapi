...
{
	[Serializable]
	public class MFN_Z2D_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z2D_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z2D_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z2D), required: true, repeating: false);
			}
