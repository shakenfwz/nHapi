...
{
	[Serializable]
	public class MFN_Z7E_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z7E_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z7E_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z7E), required: true, repeating: false);
			}
