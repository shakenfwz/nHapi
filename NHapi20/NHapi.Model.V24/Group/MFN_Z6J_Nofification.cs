...
{
	[Serializable]
	public class MFN_Z6J_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z6J_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z6J_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z6J), required: true, repeating: false);
			}
