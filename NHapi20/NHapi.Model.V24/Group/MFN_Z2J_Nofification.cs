...
{
	public class MFN_Z2J_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z2J_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z2J_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z2J), required: true, repeating: false);
			}
