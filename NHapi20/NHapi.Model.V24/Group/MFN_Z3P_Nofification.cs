...
{
	public class MFN_Z3P_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3P_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3P_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3P), required: true, repeating: false);
			}
