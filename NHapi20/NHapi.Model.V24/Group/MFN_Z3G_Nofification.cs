...
{
	[Serializable]
	public class MFN_Z3G_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3G_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3G_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3G), required: true, repeating: false);
			}
