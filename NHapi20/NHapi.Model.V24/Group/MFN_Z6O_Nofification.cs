...
{
	[Serializable]
	public class MFN_Z6O_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z6O_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z6O_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z6O), required: true, repeating: false);
			}
