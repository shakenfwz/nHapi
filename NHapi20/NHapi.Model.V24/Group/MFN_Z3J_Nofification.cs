...
{
	public class MFN_Z3J_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z3J_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z3J_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z3J), required: true, repeating: false);
			}
