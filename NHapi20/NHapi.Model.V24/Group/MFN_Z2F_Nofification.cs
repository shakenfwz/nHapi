...
{
	[Serializable]
	public class MFN_Z2F_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z2F_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z2F_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z2F), required: true, repeating: false);
			}
