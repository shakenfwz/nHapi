...
{
	[Serializable]
	public class MFN_Z4A_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z4A_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z4A_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z4A), required: true, repeating: false);
			}
