...
{
	[Serializable]
	public class MFN_Z2O_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z2O_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z2O_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z2O), required: true, repeating: false);
			}
