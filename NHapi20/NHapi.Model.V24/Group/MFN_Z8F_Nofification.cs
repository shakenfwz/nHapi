...
{
	[Serializable]
	public class MFN_Z8F_Nofification : AbstractGroup
	{
		public MFE MFE
		{
			get
		...
		public MFN_Z8F_Nofification()
			: base(null, null)
		{
		}

		public MFN_Z8F_Nofification(IGroup parent, IModelClassFactory factory)
			: base(parent, factory)
		{
			try
			{
				add(typeof(MFE), required: true, repeating: false);
				add(typeof(Z8F), required: true, repeating: false);
			}
